...
const EditMyProfile = ({ user, data }) => {
  ...
  return (
    <section>
      <div className="grid grid-cols-1 md:grid-cols-3 card bg-base-100 shadow-md ">
                ...
                <div className="flex items-center space-x-6">
                  <label className="block">
                    ...
                    <input
                      ...
                      name="img"
                      id="childImage"
                      className="btn border-none bg-[#FF428D] w-32 mt-5 block text-sm text-slate-500
          ...
          <div className="card-body">
            ...
            >
              ...
              <div className="form-control w-full max-w-xs">
                ...
                <input
                  className="btn border-none bg-[#FF428D] text-white btn-sm"
                  type="submit"
                  value="Save Change"
                />
              </div>
